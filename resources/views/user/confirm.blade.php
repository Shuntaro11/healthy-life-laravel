...
@section('content')
    ...
    <div class="recommend-container">
        ...
        <img class="graph-image" src="/images/bmi-graph-image.png">
        <h3 class="title-bar" >摂取した栄養素が数値でわかる！</h3>
        <img class="graph-image" src="/images/ate-graph-image.png">
        <h3 class="title-bar" >たくさんのレシピの中からお気に入りを保存！</h3>
        <img class="graph-image food-index-image" src="/images/food-index-image.jpg">
